...
REC(0,55,40,40,r)
VIS 4
PIN(50,90,0.000,0.000)B[0]
PIN(50,80,0.000,0.000)B[1]
PIN(50,70,0.000,0.000)B[2]
PIN(50,60,0.000,0.000)B[3]
LIG(40,55,40,95)
LIG(0,55,40,55)
LIG(0,55,0,95)
LIG(34,60,34,63)
...
PIN(120,20,2.000,0.011)Sum[3]
PIN(120,30,2.000,0.009)Sum[2]
PIN(120,40,2.000,0.009)Sum[1]
PIN(120,50,2.000,0.008)Sum[0]
...
REC(0,10,40,40,r)
VIS 4
PIN(50,45,0.000,0.000)C[0]
PIN(50,35,0.000,0.000)C[1]
PIN(50,25,0.000,0.000)C[2]
PIN(50,15,0.000,0.000)C[3]
LIG(40,10,40,50)
LIG(0,10,40,10)
LIG(0,10,0,50)
LIG(34,15,34,18)
...
REC(415,-55,15,21,r)
VIS 4
PIN(415,-25,0.000,0.000)[3]
PIN(420,-25,0.000,0.000)[2]
PIN(425,-25,0.000,0.000)[1]
PIN(430,-25,0.000,0.000)[0]
LIG(410,-60,410,-30)
LIG(435,-60,410,-60)
LIG(435,-30,435,-60)
LIG(410,-30,435,-30)
...
PIN(230,85,0.006,0.003)ZM[3]
PIN(230,95,0.006,0.003)ZM[2]
PIN(230,105,0.006,0.003)ZM[1]
PIN(230,115,0.006,0.003)ZM[0]
LIG(190,115,195,115)
LIG(190,105,195,105)
LIG(190,95,195,95)
LIG(190,85,195,85)
...
REC(290,-70,15,21,r)
VIS 4
PIN(290,-40,0.000,0.000)[3]
PIN(295,-40,0.000,0.000)[2]
PIN(300,-40,0.000,0.000)[1]
PIN(305,-40,0.000,0.000)[0]
LIG(285,-75,285,-45)
LIG(310,-75,285,-75)
LIG(310,-45,310,-75)
LIG(285,-45,310,-45)
...
LIG(270,-5,430,-5)
TEXT 96 50  #Add4
TEXT 197 -18  #Supequal10
TEXT 209 102  #sub10
FFIG F:\D-windows\A_A-Freelance-2022\Deep-Learn-Keras\A-numerique-op\Mini_projet_dsch35\add4\add4.sch
